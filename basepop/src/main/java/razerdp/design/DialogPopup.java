...
public class DialogPopup extends BasePopupWindow implements View.OnClickListener{
    ...
    public final int OK = 1,CANCEL = 2;
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.ok) {
            if (mDialogClickCallBack != null) mDialogClickCallBack.onClick(OK);
        } else if (i == R.id.cancel) {
            if (mDialogClickCallBack != null) mDialogClickCallBack.onClick(CANCEL);
        }
    }
}
